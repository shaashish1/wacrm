        ...
        <Card>
          ...
          <CardContent>
            <RadioGroup
              value={providerType}
              onValueChange={(val) => {
                setProviderType(val as 'meta' | 'wwebjs');
                // Auto-save the provider type immediately for seamless switching
                // handleSave() is complex, so we just let them click save or we can do a quick save here
              }}
