...
| Full `/api/v1` (groups, campaigns, consents, pipelines, landings) | **Partial** | Phase 2: wa-groups, consents, contact-groups, campaigns CRUD + enroll/pause/resume, pipelines/deals, landings. Group-admin + webhook delivery queue still open |
